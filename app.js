...
function renderHome(){
  ...
  const baselineBanner = `
    <div class="dday-bar" style="border-color:rgba(135,216,206,.3)">
      ${svgIco(I.target,'stroke="var(--lime)" fill="none" stroke-width="1.9" style="width:18px;height:18px;flex:0 0 auto"')}
      <div class="grow small" style="font-weight:600">Tonight becomes your <b class="lime">Day 0</b> baseline</div>
    </div>`;
